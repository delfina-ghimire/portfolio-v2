          ...
          {blogs.map((blog) => (
            <div className="flex flex-col cursor-pointer rounded-xl bg-white shadow-lg hover:shadow-xl py-5 px-5">
             ...
             <div className="relative flex items-end overflow-hidden rounded-xl">
              ...
              <div className="mt-5">
                <h2 className="text-slate-700 text-2xl">{blog.title}</h2>
              ...
              <div className="flex items-center flex-wrap ">
                <button className={`text-white bg-gradient-to-r ${blog.colors.from} ${blog.colors.to} hover:scale-105 drop-shadow-md shadow-cla-blue px-4 py-2 rounded-lg text-xl flex flex-row`}>
                  <span>Read more</span>
